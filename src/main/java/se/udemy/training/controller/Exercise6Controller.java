...
import se.udemy.training.MicroClient;
import se.udemy.training.model.Note;
import se.udemy.training.model.NoteDocument;
import se.udemy.training.model.NoteDocumentBinder;
import se.udemy.training.model.NoteDocumentRefBinder;
import se.udemy.training.model.document.Document;
import se.udemy.training.storage.NoteDocumentRepository;
import se.udemy.training.storage.NoteRepository;

/**
 * The Exercise6 controller class used for all REST methods in exercise 6.
 * 
 * @author KFB
 */
@RestController
