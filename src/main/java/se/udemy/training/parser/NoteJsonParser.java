...
import se.udemy.training.controller.Exercise5Controller;
import se.udemy.training.model.Note;

/**
 * The NoteJsonParser class that parses a JSON Note array and JSON Note objects. It creates
 * a list of Notes from the JSON Note objects.
 * 
 * @author KFB
 * @deprecated see ArrayJsonParser
 */
